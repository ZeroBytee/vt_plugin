...
function createDataTable() {
    ...
    // Admin Edit Modal HTML
    echo '<div id="adminEditModal" class="modal" style="display: none; position: fixed; z-index: 2; left: 50%; top: 50%; transform: translate(-50%, -50%);">
...
// Register the shortcode
add_shortcode('velotaxi_completedorders', 'createCompletedTable');
...
// Register the shortcode
add_shortcode('velotaxi_deletedorders', 'createDeletedTable');